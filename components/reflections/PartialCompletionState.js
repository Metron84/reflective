...
// Shown when all currently open categories are voted but more are coming.
export default function PartialCompletionState({ openCount, totalCount }) {
  const coming = totalCount - openCount;
