...
import { KOTB_FILMS } from "@/lib/kotb";
import styles from "./KotbFilms.module.css";

export default function KotbFilms() {
  return (
    <section className={styles.section} aria-labelledby="kotb-films-heading">
      <div className={styles.inner}>
        <header className={styles.header}>
          <p className={styles.eyebrow}>THE FILMS</p>
          <h2 id="kotb-films-heading" className={styles.headline}>
            Watch while the bracket fills.
          </h2>
        </header>
