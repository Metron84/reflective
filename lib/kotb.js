...
export const MATCHES = [
  {
    ...
    entrantA: sampleEntrant("SAMPLE Al Quoz Kitchen", "Al Quoz", "SAMPLE Club A", "SAMPLE Club B"),
    entrantB: sampleEntrant("SAMPLE Deira Grill", "Deira", "SAMPLE Club A", "SAMPLE Club B"),
    sourceA: null,
    sourceB: null,
    winnerTo: "sf1",
    winnerId: null,
  },
  {
    ...
    entrantA: sampleEntrant("SAMPLE Marina Counter", "Marina", "SAMPLE Club C", "SAMPLE Club D"),
    entrantB: sampleEntrant("SAMPLE Jumeirah Smoke", "Jumeirah", "SAMPLE Club C", "SAMPLE Club D"),
    sourceA: null,
    sourceB: null,
    winnerTo: "sf1",
    winnerId: null,
  },
  {
    ...
    entrantA: sampleEntrant("SAMPLE Satwa Yard", "Satwa", "SAMPLE Club E", "SAMPLE Club F"),
    entrantB: sampleEntrant("SAMPLE Al Barsha Oven", "Barsha", "SAMPLE Club E", "SAMPLE Club F"),
    sourceA: null,
    sourceB: null,
    winnerTo: "sf2",
    winnerId: null,
  },
  {
    ...
    entrantA: sampleEntrant("SAMPLE Business Bay Pit", "Bay", "SAMPLE Club G", "SAMPLE Club H"),
    entrantB: sampleEntrant("SAMPLE Karama Stack", "Karama", "SAMPLE Club G", "SAMPLE Club H"),
    sourceA: null,
    sourceB: null,
    winnerTo: "sf2",
    winnerId: null,
