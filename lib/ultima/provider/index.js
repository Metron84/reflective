...
/** Per-league count of players carrying real prior-season statistics. */
export function getProviderStatsCoverage() {
  const provider = getStatsProvider();
  return typeof provider.getStatsCoverage === "function" ? provider.getStatsCoverage() : {};
}
