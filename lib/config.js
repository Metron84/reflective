...
/** The Crest: /crest on thereflectivefootball.com. Flip false to hide. */
export const CREST_ENABLED = true;
export const CREST_PLAY_URL = "/crest";
...
/** For All The Fans: /for-all-the-fans. Flip true to preview. Keep indexable false until launch. */
export const FATF_ENABLED = true;
