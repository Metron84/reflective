...
/**
 * Canonical site sections. Header, footer Explore, and homepage cards
 * all render from this list. Keep each description under 60 characters
 * so it fits one line at a 390px phone width.
 */
export const SITE_SECTIONS = [
  ...
  },
  {
    ...
    label: "Games",
    href: "/games",
    description: "For the Fun.",
  },
  {
    id: "concierge",
    label: "Concierge",
    href: "/concierge",
    description: "Ask. Find. Watch.",
  },
  {
    id: "archive",
    label: "The Archive",
    href: "/archive",
    description: "Read. Watch. Listen.",
  },
];

export const WORK_WITH_US_HREF =
  "mailto:partnerships@thereflectivefootball.com?subject=Work%20With%20Us";
...
/** The Crest: /games card linking to the Crest PWA. Flip false to hide. */
export const CREST_ENABLED = true;
export const CREST_PLAY_URL = "https://crest.thereflectivefootball.com";
...
/** For All The Fans: /for-all-the-fans. Local preview only. Flip to false before any push until launch. */
export const FATF_ENABLED = false;
/** Flip to true on launch day: removes noindex and adds the sitemap entry. */
export const FATF_INDEXABLE = false;
/** One campaign ribbon at a time: 'fatf', 'laliga', 'kotb' or null. */
export const HOME_RIBBON = "kotb";

/** King of the Burgers: /king-of-the-burgers, nav, ribbon, sitemap. Flip true at launch. */
export const KOTB_ENABLED = true;

/**
 * Media Training: header/mobile nav item, homepage ribbon, sitemap, and
 * indexable /training. Flip true to launch.
 */
export const TRAINING_ENABLED = true;

/** Ultima: indexable /ultima and /ultima/rules, hub routes, /games card. */
export const ULTIMA_ENABLED = true;
