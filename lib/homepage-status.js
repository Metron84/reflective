...
export const STATUS = {
  ...
  archive: {
    ...
    /** Used when the long line would wrap past two lines (~380px). */
    lineShort: "What to read, watch and listen to.",
  },
};
...
export function getHomepageDoorMeta(now = new Date()) {
  ...
  return {
    ...
    archive: {
      ...
      statusLineShort: archiveEnabled ? STATUS.archive.lineShort : null,
      href: "/archive",
      external: false,
